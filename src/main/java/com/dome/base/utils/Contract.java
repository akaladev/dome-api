...
public abstract class Contract {
	...
	/**
	 * Contract that an array contains elements; that is, it must not be
	 * {@code null} and must contain at least one element.
	 * <pre class="code">Contract.notEmpty(array, "The array must contain elements");</pre>
	 ...
	 * Contract that an array contains elements; that is, it must not be
	 * {@code null} and must contain at least one element.
	 * <pre class="code">Contract.notEmpty(array);</pre>
	 * @param array the array to check
